        ...
        <div className={classNames("container-fluid", classes.container)}>
          <Grid container spacing={4}>
            <Grid item xs={12} lg={5}>
              ...
              >
                Get applications from pre-screened candidates along with a clear insight into their skills
              </Typography>
            ...
            <img src={`${process.env.PUBLIC_URL}/images/logged_out/front_screen_2.webp`} alt="Job Market" className={classes.image} />
            </Grid>
          </Grid>
        </div>
      </div>
