// src/components/JobBoard/JobDetailsData.js
const JobDetailsData = {
    // Assuming jobs are identified by some unique ID
    1 : {
      title: 'SVP, Lead Quant Strat (Portfolio and Strategy Insights)',
      company: 'Investment Insights Group',
      location: 'Singapore',
